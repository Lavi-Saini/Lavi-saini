...
I'm a **B.Tech CSE student** at Central University of Jammu passionate about building sleek, intuitive, and efficient web interfaces. I love clean code, elegant design, and solving real-world problems through the web.

- 🔭 Currently working on **Iris Lens Project**
- 🌱 Learning **Data Structures & Algorithms**
- 🏆 Won **IEEE Hackathon 2025** & **Website Design Challenge by Code Connect CUJ 2024**
- 🎨 Creative Team Member at **GDG CUJ**
- ⚡ Fun fact: I can spend hours tweaking the perfect pixel, but can't decide what to watch on Netflix in under 5 minutes 😄
...
### 🧮 Calculator Web App
> A fully responsive calculator with a clean, intuitive UI  
> `HTML` `CSS` `JavaScript`

- ✅ Full arithmetic operations (add, subtract, multiply, divide)
- ✅ User-friendly button layout with error-free input handling
- ✅ Responsive design across all devices

---

### ✅ To-Do List Web Application
> A task management app to organize and manage daily tasks  
> `HTML` `CSS` `JavaScript`

- ✅ Add, delete, and manage tasks dynamically
- ✅ Attractive and minimal UI for better productivity
- ✅ JavaScript-powered real-time task updates
...
| 🥇 Achievement | 📅 Year |
|---|---|
| Won IEEE Hackathon | 2025 |
| Won Website Design Challenge — Code Connect CUJ | 2024 |
| Top 3 — Anant Khel Award (University Level) | — |
